...
LIVE_MEDIA_PKG_CONFIG_PRE_OPTIONS = PKG_CONFIG_PATH=$(PWD)
...
LD_FLAGS = $(LIVE_MEDIA_LIBS) $(FFMPEG_LIBS) $(SDL_LIBS) -L/usr/lib/x86_64-linux-gnu -lXv -lXext -lX11 -lz -lpthread -lm -ldl 
